...
export const programMeta = {
  ...
  version: 'Salesforce Communications Cloud Prototype - Connected End-to-End Flow',
  sponsor: 'Steve Manz, CFO',
  approach:
    'Salesforce Communications Cloud replaces CloudCore for quote-to-order, while Sage Intacct remains the invoicing, revenue, and reporting system of record.',
  currentMonth: 'M3',
  cloudCoreStatus: 'CloudCore active - parallel run planned M7-M8',
};
...
export const initialQuotes: Quote[] = [
  { id: 'Q-2026-0142', customerId: 'CUST-001', customer: 'Silver Bow Communications', vertical: 'Oil & Gas', productId: 'PRD-001', product: 'Continuum Starlink Data Pool (500 terminals)', quantity: 500, unitPrice: 135, amount: 67500, status: 'converted', createdDate: '2026-01-15', daysOpen: 45, approver: 'Demi (interim)' },
  { id: 'Q-2026-0187', customerId: 'CUST-002', customer: 'Pecos Energy Services', vertical: 'Oil & Gas', productId: 'PRD-003', product: 'Sentinel Managed OT Security', quantity: 1, unitPrice: 142000, amount: 142000, status: 'pending_approval', createdDate: '2026-05-28', daysOpen: 4, approver: 'Demi (interim)' },
  { id: 'Q-2026-0191', customerId: 'CUST-003', customer: 'Red Mesa Mining', vertical: 'Mining', productId: 'PRD-002', product: 'Continuum Private LTE Site Bundle (250 SIMs)', quantity: 250, unitPrice: 155, amount: 38750, status: 'stuck', createdDate: '2026-03-02', daysOpen: 91, pricingError: 'Bulk rate $155 vs approved $135/sim' },
  { id: 'Q-2026-0198', customerId: 'CUST-004', customer: 'Diamondback Midstream', vertical: 'Maritime', productId: 'PRD-004', product: 'Continuum Managed Network + SLA', quantity: 1, unitPrice: 218400, amount: 218400, status: 'converted', createdDate: '2026-05-10', daysOpen: 2, approver: 'Demi (interim)' },
  { id: 'Q-2026-0203', customerId: 'CUST-005', customer: 'Vital Connect LLC', vertical: 'Utilities', productId: 'PRD-005', product: 'Nexora Edge Monitoring', quantity: 1, unitPrice: 56400, amount: 56400, status: 'converted', createdDate: '2026-06-01', daysOpen: 1, approver: 'Demi (interim)' },
];
...
export const initialOrders: Order[] = [
  ...
  { id: 'ORD-8855', quoteId: 'Q-2026-0191', customerId: 'CUST-003', customer: 'Red Mesa Mining', amount: 38750, status: 'held', submittedDate: '2026-04-05', fieldTicketsRequired: 2, fieldTicketsUploaded: 0, holdReason: 'Pricing discrepancy unresolved' },
];
...
export const initialDisputes: Dispute[] = [
  { id: 'DSP-001', invoiceId: 'INV-43988', customerId: 'CUST-006', customer: 'Exxon Permian Ops', reason: 'Billing amount does not match contract rate', status: 'investigating', rootCause: 'Pricing mismatch on Sentinel security line items', openedDate: '2026-03-20', assignedTo: 'Customer Success' },
...
export const programGates = [
  { id: 'gate-0', name: 'Gate 0 - Mobilize & Assess', when: 'End M1', status: 'passed' as const, owner: 'Steve Manz', criteria: ['Baselines captured', 'Charter approved', 'Near-term fix track underway', 'Salesforce replacement scope confirmed'] },
  { id: 'gate-1', name: 'Gate 1 - Design & Blueprint', when: 'End M3', status: 'current' as const, owner: 'Steering Committee', criteria: ['To-be processes signed off', 'KPI targets locked', 'Data model & integration design approved', 'Budget confirmed'] },
  { id: 'gate-2', name: 'Gate 2 - Build Complete', when: 'End M6.5', status: 'pending' as const, owner: 'Stan Hughey', criteria: ['CPQ configured', 'Intacct invoicing flow built', 'End-to-end integration demonstrated', 'No open critical defects'] },
...
export const workstreams = [
  ...
  { id: 'ws3', name: 'WS3 - Invoice-to-Cash', lead: 'Steve Manz', phase: 'Near-term fixes active', progress: 40, nearTermActions: ['Dunning ladder enforced in Sage Intacct', 'Weekly AR aging review standing', 'Exxon / Diamondback / Apache recovery plans active'] },
...
export const openDecisions: ProgramDecision[] = [
  ...
  { id: 'dec-3', title: 'Salesforce Build Partner', owner: 'Steve / Stan', status: 'pending', summary: 'Choose the SI partner needed to hold the compressed plan and govern Salesforce delivery.' },
...
export const architectureComparison = {
  thirdParty: {
    label: 'Current State',
    systems: ['Salesforce used mainly for contact data', 'CloudCore handles orders, delivery, invoicing, and collections', 'Sage Intacct manages accounting and supply chain', 'Manual onboarding, approvals, and document chasing', 'Triple-entry customer master across SF, Intacct, and CloudCore'],
    pros: ['Legacy process familiarity', 'Existing operational history'],
    cons: ['45-day billing lag', 'Pricing and support-document errors', 'Revenue leakage and weak collections'],
  },
  custom: {
    label: 'Target State',
    systems: ['Salesforce Communications Cloud (Industries CPQ + EPC + Order Management)', 'Salesforce / FormAssembly onboarding with Avalara + DocuSign', 'Native Salesforce <-> Sage Intacct integration', 'Sage Intacct owns invoicing, rev rec, AR, and financial reporting', 'CloudCore retired after pilot, parallel run, and cutover'],
    pros: ['Documented handoffs across all three Q2C stages', 'Governed pricing, approvals, and onboarding gates', 'Clean operational platform integrated to finance'],
    cons: ['Requires SI partner capacity and tight decisions', 'Parallel run and migration discipline are mandatory', 'Subscription and usage-billing boundaries must be validated'],
  },
};
